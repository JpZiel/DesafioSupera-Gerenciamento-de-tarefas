package com.gerenciamento_tarefas.Gerenciamento_tarefas.controllers;
...
import com.gerenciamento_tarefas.Gerenciamento_tarefas.service.ItemService;
...
public class ItemController {
    ...
    public ResponseEntity<Item> updateItemEstado(@PathVariable Long id, @RequestBody EstadoDoItem novoEstado) {
